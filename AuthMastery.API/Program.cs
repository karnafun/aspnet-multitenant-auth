...
try
{
    ...
    builder.Services.AddProblemDetails(options =>
    {
        options.IncludeExceptionDetails = (ctx, ex) =>
            builder.Environment.IsDevelopment(); // Only show details in dev


        options.Map<NotFoundException>(ex => new StatusCodeProblemDetails(404));
        options.Map<UnauthorizedException>(ex => new StatusCodeProblemDetails(401));
        options.Map<BadRequestException>(ex => new StatusCodeProblemDetails(400));
    });
