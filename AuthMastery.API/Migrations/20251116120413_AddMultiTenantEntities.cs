    ...
    public partial class AddMultiTenantEntities : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectWatchers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectWatchers_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_ProjectWatchers_Projects_ProjectId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectWatchers_ProjectId",
                table: "ProjectWatchers",
                column: "ProjectId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectWatchers_UserId_ProjectId",
                table: "ProjectWatchers",
